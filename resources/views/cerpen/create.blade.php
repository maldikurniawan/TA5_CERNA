...
<div class="w-full items-center justify-start bg-white">
    <div class="mx-auto w-full min-h-screen">
        ...
        <form action="{{route('cerpen.store')}}" method="POST">
            @csrf
            <div class="grid gap-6 sm:grid-cols-2">
                ...
                <div class="relative z-0">
                    <input type="date" name="tanggal"
                        ...
                        placeholder=" " />
                    <label
                        class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-500">Tanggal*</label>
                </div>
                <div class="relative z-0 col-span-2">
                    <input type="text" name="email"
                        ...
                        placeholder=" " />
                    <label
                        class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-blue-600 peer-focus:dark:text-blue-500">Email*</label>
                </div>
                <div class="relative z-0 col-span-2">
            ...
            <button type="submit" class="mt-5 rounded-md bg-black px-10 py-2 text-white">Kirim</button>
        </form>
    </div>
</div>
@endsection
